...
\begin{document}
    ...
    \begin{center}
        \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X|p{0.32\textwidth}}
            \textbf{\Huge{Anmol Chawla}} &
                {\begin{tabularx}{0\textwidth}{>{\raggedleft\arraybackslash}p{0.32\textwidth}}
                        {+917397263483} \\
                \end{tabularx}} \\
                \multirow{3}{*}{\LARGE{\color{\primarycolor}\designation}}
                                         & {\begin{tabularx}{0\textwidth}{>{\raggedleft\arraybackslash}p{0.32\textwidth}}
                                                 {Bangalore, Karnataka} \\
                                         \end{tabularx}}\\

                                         & {\begin{tabularx}{0\textwidth}{>{\raggedleft\arraybackslash}p{0.32\textwidth}}
                                                 {\href{mailto:anmolchawla10@gmail.com}{\small anmolchawla10@gmail.com}} \\
                                         \end{tabularx}} \\
                                         & {\begin{tabularx}{0\textwidth}{>{\raggedleft\arraybackslash}p{0.32\textwidth}}
                                                 {\href{https://www.linkedin.com/in/anmolchawla1998/}{\footnotesize linkedin.com/in/anmolchawla1998/}} \\
                                         \end{tabularx}} \\
        \end{tabularx}
    \end{center}
